...
minetest.register_decoration({
	deco_type = "simple",
	place_on = { "mcl_core:silver_sand" },
	sidelen = 16,
	place_offset_y = -2,
	flags = "force_placement",
	fill_ratio = 1.0,
	biomes = { "mcl_core:cold_desert", "mcl_core:cold_desert_ocean" },
	y_max = 300,
	y_min = 0,
	decoration = "mcl_core:sand"
})
...
local function grow_new_pine_tree(pos)
	...
	minetest.place_schematic({ x = pos.x - 3, y = pos.y - 0, z = pos.z - 3 },
		modpath .. "/schematics/livingdesert_pine.mts", "0", nil, false)
end
...
local function grow_new_pine2_tree(pos)
	...
	minetest.remove_node(pos)
	minetest.place_schematic({ x = pos.x - 3, y = pos.y - 0, z = pos.z - 3 },
		modpath .. "/schematics/livingdesert_pine2.mts", "0", nil, false)
end
...
local function grow_new_pine3_tree(pos)
	...
	minetest.remove_node(pos)
	minetest.place_schematic({ x = pos.x - 3, y = pos.y - 0, z = pos.z - 3 },
		modpath .. "/schematics/livingdesert_pine3.mts", "0", nil, false)
end
...
mcl_fences.register_fence_def(
	"livingdesert:fence_pine_wood",
	{
		...
		inventory_image =
		"default_fence_overlay.png^livingdesert_pine_wood.png^default_fence_overlay.png^[makealpha:255,126,126",
		wield_image =
		"default_fence_overlay.png^livingdesert_pine_wood.png^default_fence_overlay.png^[makealpha:255,126,126",
		material = "livingdesert:pine_wood",
...
local function grow_new_saxaul_tree(pos)
	...
	minetest.remove_node(pos)
	minetest.place_schematic({ x = pos.x - 2, y = pos.y - 0, z = pos.z - 2 },
		modpath .. "/schematics/livingdesert_saxaul.mts", "0", nil, false)
end
...
mcl_fences.register_fence_def(
	"livingdesert:fence_saxaul_wood",
	{
		...
		inventory_image =
		"default_fence_overlay.png^livingdesert_saxaul_wood.png^default_fence_overlay.png^[makealpha:255,126,126",
		wield_image =
		"default_fence_overlay.png^livingdesert_saxaul_wood.png^default_fence_overlay.png^[makealpha:255,126,126",
		material = "livingdesert:saxaul_wood",
		groups = { choppy = 2, oddly_breakable_by_hand = 2, flammable = 2 },
